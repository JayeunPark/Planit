                           ...
                           <div id="cate_food${i}" class="cate_food" >
                              ...
                              <input type="hidden" name="cnt" value="food-${i}">
                                 ...
                                 <div class="fd_header_rt" id="fd_header_rt">
                                       ...
                                       <input type="range" name="fdstar-${i}" id="fdstar-${i}" value="1" step="1" min="0" max="10"  oninput="drawStar(this)">
                                    </span>
                                 </div>
                                 </div>
                                 ...
                                 <div class="inner">
                                    <div id="cul_top" style="position:relative;">
                                       ...
                                       <span id="star" class = "star">
                                          ...
                                          <input type="range" name="culstar-${i}" id="culstar-${i}"value="1" step="1" min="0" max="10"  oninput="drawStar(this)">
                                       </span>
                                    </div>
                                    <div id="cul_contents">
                                       <div id="culimg"></div>
