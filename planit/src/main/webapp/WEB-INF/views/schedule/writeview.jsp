                           ...
                           <c:choose>
                            ...
                            <div class="hidden" id="friend_addlist">
                               ...
                               <c:choose>
                                  <c:when test="${result != null}">
                                     <c:choose>
                                        <c:when test="${fn:length(nocheckFriendList) > 0}">
                                           <c:forEach var="i" begin="0" end="${(fn:length(nocheckFriendList)-1)}">
                                              <div id="friendDiv${i}">
                                              <label for="friend${i}" id="friendlabel${i}">${nocheckFriendList.get(i).username}</label>
                                              <input type="checkbox" name="friends" id="friend${i}" value="${nocheckFriendList.get(i).userid}">
                                              </div>
                                           </c:forEach>
                                        </c:when>
                                     </c:choose>
